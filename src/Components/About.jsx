    ...
    <div id='about'>
      ...
      <div className='about-text'>
        ...
        {showSecondText && (
         ...
         <p>
            Our clinic is committed to delivering personalized dental solutions that cater to your unique needs. Whether you're seeking general dentistry services, teeth whitening, orthodontics, or restorative treatments, we have you covered.
