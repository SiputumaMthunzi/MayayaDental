    ...
    <div id='info'>
      ...
      <div className="dentist-card">
        ...
        <div className="dentist-info">
          <p>
            Dr. Lwando Mayaya is a skilled and compassionate dentist with a degree in Dentistry from the University of Western Cape. <br></br>
            He is dedicated to providing top-quality dental care, staying up-to-date with the latest advancements in the field.
            <br></br> Dr. Mayaya creates a welcoming environment for his patients and excels in general dentistry, preventive care, and cosmetic procedures.
